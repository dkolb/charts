...
Copied from https://github.com/MoJo2600/pihole-kubernetes

(Go use his chart. Really. This is just because I don't trust anyone and helm
doesn't really provide the sort of guarantees I want about a chart of a
particular version being immutable beyond pulling it. This means that I have to
carefully review each application of the chart. Just easier to stuff it in my
own repo and copy over an update if I need to.)

Installs pihole in kubernetes

![Version: 1.8.29-dkolb1](https://img.shields.io/badge/Version-1.8.29--dkolb1-informational?style=flat-square) ![AppVersion: 5.2.4](https://img.shields.io/badge/AppVersion-5.2.4-informational?style=flat-square) <!-- ALL-CONTRIBUTORS-BADGE:START - Do not remove or modify this section -->
